...
<body bgcolor="black">
	...
	<tr>
		...
		<table>
                     <form action="mDeleteOk" method="post" name="delete_form">
                           
                           <input class="input_box" type="hidden" value="${mmemberDto.mmid}" name="mmid">
                           <input class="input_box" type="hidden" value="${mmemberDto.mmpw}" name="mmpw">
                           
                        <tr>
                           <td><span class="content_text">비밀번호 입력 &nbsp;</span></td>
                           <td><input  class="input_box" type="password" name="mmpw_check" ></td>
                        </tr>
                        <tr>
                           <td colspan="2">
                              <input class="button" type="button" value="회원탈퇴" onclick="mdeleteCheck()">
